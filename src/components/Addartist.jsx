...
const Addartist = (prop) => {
   
    return(
        <>
           <div id="extralarge-modal" tabindex="-1" className="hidden overflow-y-auto overflow-x-hidden backdrop-blur-2xl fixed top-0 right-0 left-40 z-50 w-full md:inset-0 h-modal md:h-full px-52">
